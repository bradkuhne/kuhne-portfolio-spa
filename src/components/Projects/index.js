...
import Image2 from "../../assets/run-buddy.png";
import Image1 from "../../assets/viewsnvibes.png";
        ...
        <div>
            <div className="flex-row space-between" style={{ textAlign: "center" }}>
                <div className="card my-2 py-2">
                    <p>viewsNVibes</p>
                    <img src={Image1} className="my-2" alt="viewsNVibes" />
                    <p>MERN stack PWA for booking tour guides</p>
                    <a href="https://viewsnvibes.herokuapp.com/" className="button">GitHub Link</a> <br></br>
                    <a href="https://viewsnvibes.herokuapp.com/" className="button">Heroku Link</a>
                </div>
                <div className="card my-2 py-2">
                    <p>Run Buddy</p>
                    <img src={Image2} className="my-2" alt="Run Buddy" />
