...
function About() {
    const shortBio = `SMU Full Stack Coding Bootcamp student and consistently high-performing project leader. Knowledgeable
    in the MERN (MongoDB, ExpressJS, React, and NodeJS) stack as well as HTML, CSS, JavaScript, Sequelize, APIs and Git. Certified Scrum Master (CSM) and Project Management Professional (PMP). Performance management, data warehouse, 
